...
class Tpl_block_left_eng extends Admin_Controller
{
    var $moduleName = 'tpl_block';
    var $tables;

    function Tpl_block_left_eng()
    {
    ...
    function index()
    {
        $Left = $this->db->from($this->tables['tpl_block'])->where('side', 'left_eng')->get()->result_array();

        $this->module->parse($this->moduleName, 'tpl_block_left.php', array(
            'form_open' => form_open('admin/tpl_block/tpl_block_left_eng/save'),
    ...
    function save()
    {
        ...
        $this->db->delete($this->tables['tpl_block'], array('side' => 'left_eng'));
        $this->db->insert($this->tables['tpl_block'], array('title' => $title,'body' => $body, 'side'=>'left_eng'));

        redirect('admin/tpl_block/tpl_block_left_eng');
    }
}
?>
