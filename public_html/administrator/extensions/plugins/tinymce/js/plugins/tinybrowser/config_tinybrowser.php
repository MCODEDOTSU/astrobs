...
//$tinybrowser['link']['image'] = 'http://minec.astrobl.ru/uploads/images/'; // Image links
//$tinybrowser['link']['media'] = 'http://minec.astrobl.ru/uploads/media/'; // Media links
//$tinybrowser['link']['file']  = 'http://minec.astrobl.ru/uploads/files/'; // Other file links
